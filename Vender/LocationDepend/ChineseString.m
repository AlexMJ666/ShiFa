...
+(NSMutableArray*)IndexArray:(NSArray*)stringArr
{
    ...
    [A_Result insertObject:@"定位" atIndex:0];
    [A_Result insertObject:@"热门" atIndex:0];
    return A_Result;
}
...
+(NSMutableArray*)LetterSortArray:(NSArray*)stringArr
{
    ...
    item = [NSMutableArray arrayWithObjects:@"", nil];
    [LetterResult insertObject:item atIndex:0];
    [LetterResult insertObject:item atIndex:0];
    return LetterResult;
}
...
+(NSMutableArray*)ReturnSortChineseArrar:(NSArray*)stringArr
{
    ...
    //    }
    NSLog(@"-----------------------------");
//    ChineseString *tempChineseString = [[ChineseString alloc]init];
//    tempChineseString.pinYin = @"";
//    tempChineseString.string = @"定位";
//    [chineseStringsArray addObject:chineseString];
